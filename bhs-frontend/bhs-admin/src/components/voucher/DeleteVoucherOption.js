...
function DeleteVoucherOption({hide, setDate, id, name }) {

    function HandleDeleteVoucherOption() {
        axios.post(SERVER_API_URL + 'api/admin/delete-voucher-option', [id]).then(res => {
            setDate();
        })
    }
    return (
            ...
            <div className='modal-wrapper w-25'>
                ...
                <div className='modal-body'>
                    ...
                    <p className='fs-5 text'>
                        Do you want to delete voucher: {name} ?
                    </p>
                </div>
                <div className='modal-control mb-4'>
                    <button type='button' className='btn btn-danger mx-4 ' style={{width: "5rem"}}  onClick={() => {HandleDeleteVoucherOption();hide()}} >Delete</button>
...
export default DeleteVoucherOption;
